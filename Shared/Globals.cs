...
namespace Shared {
    public static class Globals {
        public static readonly List<Person> PersonList = new List<Person>() {
            ...
            {4,"Elisha","Le Prevost","eleprevost3@aol.com","1996-09-02T03:50:10Z"},
            {5,"Hodge","Vigar","hvigar4@mozilla.org","1998-04-15T12:32:44Z"},
            ...
            {13,"Nelle","Beer","nbeerc@github.com","1983-02-12T08:58:05Z"},
            ...
            {18,"Val","Szubert","vszuberth@wunderground.com","1998-03-23T21:42:46Z"},
            {19,"Major","Peto","mpetoi@t.co","1993-02-18T22:48:14Z"},
            ...
            {23,"Goldarina","De Lorenzo","gdelorenzom@amazon.co.jp","2003-08-31T10:38:12Z"},
            {24,"Chaddie","Slack","cslackn@cnet.com","1988-02-06T13:47:21Z"},
            ...
            {32,"Rosalie","Bergeau","rbergeauv@umich.edu","1995-03-02T09:51:28Z"},
            ...
            {40,"Aloysia","Bamber","abamber13@issuu.com","1981-09-24T10:39:34Z"},
            {41,"Veronique","Agron","vagron14@blogger.com","2004-01-14T06:48:21Z"},
            ...
            {45,"Manon","Emanuelli","memanuelli18@goo.gl","1987-02-14T19:34:22Z"},
            ...
            {50,"Sansone","Raymen","sraymen1d@slashdot.org","2008-04-07T08:12:31Z"},
            ...
            {54,"Huberto","Vawton","hvawton1h@huffingtonpost.com","1994-05-09T06:25:00Z"},
            ...
            {58,"Francklyn","Lamperd","flamperd1l@unblog.fr","1993-10-26T08:49:39Z"},
            {59,"Paulie","Tilby","ptilby1m@illinois.edu","1993-12-12T17:43:44Z"},
            ...
            {63,"Lance","Mountford","lmountford1q@smh.com.au","1982-04-02T14:56:01Z"},
            {64,"Frederich","Hickeringill","fhickeringill1r@google.com","1933-06-11T05:12:39Z"},
            {65,"Amalea","Blyth","ablyth1s@paypal.com","1999-12-13T16:52:05Z"},
            ...
            {68,"Devonne","Gumbley","dgumbley1v@guardian.co.uk","1997-04-28T16:12:27Z"},
            ...
            {71,"Charlean","MacKowle","cmackowle1y@pcworld.com","1987-03-07T22:48:02Z"},
            ...
            {75,"Sigfrid","Benley","sbenley22@marriott.com","1992-02-26T17:32:45Z"},
        ...
        public static string DbPath {
            get {
                if (_dbPath.IsNullOrWhitespace()) {
                    var currentFolder = Directory.GetCurrentDirectory();
                    var testPath = Path.Combine(currentFolder, "People.db");
                    while (!File.Exists(testPath)) {
                        currentFolder = Path.GetDirectoryName(currentFolder);
                        testPath = Path.Combine(currentFolder, "People.db");
                    }
                    _dbPath = testPath;
                }
                return _dbPath;
